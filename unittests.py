...
class TestRouletteFunctions(unittest.TestCase):
    ...
    def test_evidence_uniform(self):
        ...
        markov = pt.MarkovChain(use_prior=True, prior=1., specific_prior=ret1,
        ...
        markov = pt.MarkovChain(use_prior=True, prior=2., modus="bayes",state_count=5, reset=False)
        markov.prepare_data(trails)
        markov.fit(trails)
    ...
    def test_evidence_uniform_morestates(self):
        ...
        markov = pt.MarkovChain(use_prior=True, prior=2., modus="bayes", state_count=6, reset=False)
        markov.prepare_data(trails)
        markov.fit(trails)
